...
metadata:
  name: cluster
spec:
  scyllaUtilsImage: "docker.io/scylladb/scylla-enterprise:2026.2.2"
```
...
- [Configure nodes](https://operator.docs.scylladb.com/master/deploy-scylladb/before-you-deploy/configure-nodes.md) — performance tuning that uses the `scyllaUtilsImage`.
- [Set up monitoring](https://operator.docs.scylladb.com/master/deploy-scylladb/set-up-monitoring/index.md) — monitoring stack that uses the Grafana and Prometheus settings.
- [Tuning architecture](https://operator.docs.scylladb.com/master/understand/tuning.md) — how tuning scripts are executed.
